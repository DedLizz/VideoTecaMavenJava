<%-- 
    Document   : recuperarone
    Created on : 4 jun. 2024, 21:30:50
    Author     : Brandon
--%>
...
<body>
    <div class="container">
        <div class="card">
            <div class="card-body">
                <h3 class="card-title text-center">Recuperar cuenta</h3>
                <form action="ServletRecuperarCuenta?accion=recuperar" method="post">
                    <div class="form-group">
                        <label for="email">Correo electrónico</label>
                        <input type="email" class="form-control" id="email" name="EmailPagLog" placeholder="Ingresa tu correo" required>
                    </div>
