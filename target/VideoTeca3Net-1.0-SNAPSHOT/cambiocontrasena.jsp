<%-- 
    ...
    Created on : 4 jun. 2024, 23:15:46
    Author     : Brandon
--%>
...
<body>
    <div class="container">
        <div class="card">
            <div class="card-body">
                <h3 class="card-title text-center">Hola de nuevo ${sessionScope.nombre}, ingresa la contraseña nueva</h3>
                <form id="passwordForm" action="ServletRecuperarCuenta?accion=actualizar" method="post">
                    <div class="form-group" style="display: none;">
                        <input type="text" class="form-control"  name="idPersonaPag" value="${sessionScope.id}" required>
                    </div>
                    <div class="form-group">
                        <label for="password">Contraseña nueva</label>
                        <input type="password" class="form-control" id="password" placeholder="Ingresa tu nueva contraseña" required>
                    </div>
                    <div class="form-group">
                        <label for="confirmPassword">Confirmar contraseña</label>
                        <input type="password" class="form-control" id="confirmPassword" name="confirmaContrasenaPag" placeholder="Confirma tu nueva contraseña" required>
                        <div class="invalid-feedback">Las contraseñas no coinciden.</div>
                    </div>
                    <!-- Checkbox para mostrar contraseñas -->
                    <div class="form-check">
                        <input type="checkbox" class="form-check-input" id="showPasswordCheckbox">
                        <label class="form-check-label" for="showPasswordCheckbox">Mostrar contraseñas</label>
                    </div>
                    <!-- Mostrar la contraseña ingresada -->
                    <div id="showPassword" style="display: none;"></div>
    ...
    <script>
        ...
        document.getElementById('confirmPassword').addEventListener('input', function() {
            ...
            var invalidFeedback = confirmPasswordInput.nextElementSibling;
