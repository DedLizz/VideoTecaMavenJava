...
/*##############################################################*/
    ...
    /*fin de estilos a editar */
    
    
    
    
 /*estilos de carta 22 de paquete 2*/   
...
.card22 {
    ...
    width: 200px;
    height: 250px;
    background-color: rgba(236, 125, 255, 0.5); /* Fondo con transparencia */
...
.card22:hover {
    ...
    border-color: #ff8cff; /* Color del borde neon al hacer hover */
    outline: 2px solid #ff8cff; /* Contorno exterior con color neon */
}
...
.card33 {
    ...
    width: 200px;
    height: 250px;
    background-color: rgba(247, 202, 27, 0.5); /* Fondo con transparencia */
